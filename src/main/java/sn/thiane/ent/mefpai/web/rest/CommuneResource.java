...
import sn.thiane.ent.mefpai.domain.Commune;
import sn.thiane.ent.mefpai.repository.CommuneRepository;
...
/**
 * REST controller for managing {@link sn.thiane.ent.mefpai.domain.Commune}.
 */
@RestController
@RequestMapping("/api")
@Transactional
