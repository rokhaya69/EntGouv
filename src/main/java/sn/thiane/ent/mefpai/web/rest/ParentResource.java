...
import sn.thiane.ent.mefpai.domain.Parent;
import sn.thiane.ent.mefpai.repository.ParentRepository;
...
/**
 * REST controller for managing {@link sn.thiane.ent.mefpai.domain.Parent}.
 */
@RestController
@RequestMapping("/api")
@Transactional
