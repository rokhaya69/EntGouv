...
import sn.thiane.ent.mefpai.domain.Cours;
import sn.thiane.ent.mefpai.repository.CoursRepository;
...
/**
 * REST controller for managing {@link sn.thiane.ent.mefpai.domain.Cours}.
 */
@RestController
@RequestMapping("/api")
@Transactional
