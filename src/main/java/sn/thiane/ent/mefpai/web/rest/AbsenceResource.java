...
import sn.thiane.ent.mefpai.domain.Absence;
import sn.thiane.ent.mefpai.repository.AbsenceRepository;
...
/**
 * REST controller for managing {@link sn.thiane.ent.mefpai.domain.Absence}.
 */
@RestController
@RequestMapping("/api")
@Transactional
