...
import sn.thiane.ent.mefpai.domain.Note;
import sn.thiane.ent.mefpai.repository.NoteRepository;
...
/**
 * REST controller for managing {@link sn.thiane.ent.mefpai.domain.Note}.
 */
@RestController
@RequestMapping("/api")
@Transactional
