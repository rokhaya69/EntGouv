...
public class Evaluation implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "cours", "evaluations", "programme" }, allowSetters = true)
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "user", "cours", "evaluations", "etablissement" }, allowSetters = true)
    ...
    public String getTypeEvalu() {
        return this.typeEvalu;
    }

    public Evaluation typeEvalu(String typeEvalu) {
        this.setTypeEvalu(typeEvalu);
        return this;
    }

    public void setTypeEvalu(String typeEvalu) {
    ...
    public void setPersoAdmins(Set<PersoAdmin> persoAdmins) {
        if (this.persoAdmins != null) {
            this.persoAdmins.forEach(i -> i.removeEvaluation(this));
        }
        if (persoAdmins != null) {
            persoAdmins.forEach(i -> i.addEvaluation(this));
        }
        this.persoAdmins = persoAdmins;
    }

    public Evaluation persoAdmins(Set<PersoAdmin> persoAdmins) {
        this.setPersoAdmins(persoAdmins);
        return this;
    }

    public Evaluation addPersoAdmin(PersoAdmin persoAdmin) {
        this.persoAdmins.add(persoAdmin);
        persoAdmin.getEvaluations().add(this);
        return this;
    }

    public Evaluation removePersoAdmin(PersoAdmin persoAdmin) {
        this.persoAdmins.remove(persoAdmin);
        persoAdmin.getEvaluations().remove(this);
        return this;
    }
