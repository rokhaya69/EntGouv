...
describe('PersoAdmin Management Component', () => {
  let comp: PersoAdminComponent;
  let fixture: ComponentFixture<PersoAdminComponent>;
  let service: PersoAdminService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'perso-admin', component: PersoAdminComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PersoAdminComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.persoAdmins?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
