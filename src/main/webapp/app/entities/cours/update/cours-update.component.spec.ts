...
describe('Cours Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call syllabus query and add missing value', () => {
      ...
      const expectedCollection: ISyllabus[] = [syllabus, ...syllabusCollection];
      ...
      expect(syllabusService.addSyllabusToCollectionIfMissing).toHaveBeenCalledWith(syllabusCollection, syllabus);
      expect(comp.syllabiCollection).toEqual(expectedCollection);
    });
    ...
    it('Should update editForm', () => {
      ...
      expect(comp.syllabiCollection).toContain(syllabus);
