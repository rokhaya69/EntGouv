...
import sn.thiane.ent.mefpai.repository.PosteRepository;
...
class PosteResourceIT {
    ...
    private static final NomPoste DEFAULT_NOM_POSTE = NomPoste.Mefpai;
    private static final NomPoste UPDATED_NOM_POSTE = NomPoste.Inspecteur;
