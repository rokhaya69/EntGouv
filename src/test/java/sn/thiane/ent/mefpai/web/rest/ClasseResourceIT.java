...
import sn.thiane.ent.mefpai.repository.ClasseRepository;
...
class ClasseResourceIT {
    ...
    public static Classe createEntity(EntityManager em) {
        Classe classe = new Classe().titre(DEFAULT_TITRE).niveauEtude(DEFAULT_NIVEAU_ETUDE);
        return classe;
    }
    ...
    public static Classe createUpdatedEntity(EntityManager em) {
        Classe classe = new Classe().titre(UPDATED_TITRE).niveauEtude(UPDATED_NIVEAU_ETUDE);
        return classe;
    }
    ...
    void putNewClasse() throws Exception {
        ...
        updatedClasse.titre(UPDATED_TITRE).niveauEtude(UPDATED_NIVEAU_ETUDE);
    ...
    void fullUpdateClasseWithPatch() throws Exception {
        ...
        partialUpdatedClasse.titre(UPDATED_TITRE).niveauEtude(UPDATED_NIVEAU_ETUDE);
