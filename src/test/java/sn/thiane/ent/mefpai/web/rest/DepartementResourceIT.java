...
import sn.thiane.ent.mefpai.domain.Departement;
import sn.thiane.ent.mefpai.domain.enumeration.NomDept;
import sn.thiane.ent.mefpai.repository.DepartementRepository;
...
class DepartementResourceIT {
    ...
    public static Departement createEntity(EntityManager em) {
        Departement departement = new Departement().nomDept(DEFAULT_NOM_DEPT);
        return departement;
    }
    ...
    public static Departement createUpdatedEntity(EntityManager em) {
        Departement departement = new Departement().nomDept(UPDATED_NOM_DEPT);
        return departement;
    }
    ...
    void putNewDepartement() throws Exception {
        ...
        updatedDepartement.nomDept(UPDATED_NOM_DEPT);
    ...
    void partialUpdateDepartementWithPatch() throws Exception {
        ...
        partialUpdatedDepartement.nomDept(UPDATED_NOM_DEPT);
