...
import sn.thiane.ent.mefpai.domain.Programme;
import sn.thiane.ent.mefpai.repository.ProgrammeRepository;
...
class ProgrammeResourceIT {
    ...
    public static Programme createEntity(EntityManager em) {
        Programme programme = new Programme().nomProgram(DEFAULT_NOM_PROGRAM).annee(DEFAULT_ANNEE);
        return programme;
    }
    ...
    public static Programme createUpdatedEntity(EntityManager em) {
        Programme programme = new Programme().nomProgram(UPDATED_NOM_PROGRAM).annee(UPDATED_ANNEE);
        return programme;
    }
    ...
    void putNewProgramme() throws Exception {
        ...
        updatedProgramme.nomProgram(UPDATED_NOM_PROGRAM).annee(UPDATED_ANNEE);
    ...
    void partialUpdateProgrammeWithPatch() throws Exception {
        ...
        partialUpdatedProgramme.nomProgram(UPDATED_NOM_PROGRAM).annee(UPDATED_ANNEE);
