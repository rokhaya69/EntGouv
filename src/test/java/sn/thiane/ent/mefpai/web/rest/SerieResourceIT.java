...
import sn.thiane.ent.mefpai.domain.enumeration.NomSerie;
import sn.thiane.ent.mefpai.repository.SerieRepository;
...
class SerieResourceIT {
    ...
    public static Serie createEntity(EntityManager em) {
        Serie serie = new Serie().nomSerie(DEFAULT_NOM_SERIE);
        return serie;
    }
    ...
    public static Serie createUpdatedEntity(EntityManager em) {
        Serie serie = new Serie().nomSerie(UPDATED_NOM_SERIE);
        return serie;
    }
    ...
    void putNewSerie() throws Exception {
        ...
        updatedSerie.nomSerie(UPDATED_NOM_SERIE);
    ...
    void fullUpdateSerieWithPatch() throws Exception {
        ...
        partialUpdatedSerie.nomSerie(UPDATED_NOM_SERIE);
