...
import sn.thiane.ent.mefpai.domain.Evaluation;
import sn.thiane.ent.mefpai.repository.EvaluationRepository;
...
class EvaluationResourceIT {
    ...
    private static final String DEFAULT_TYPE_EVALU = "AAAAAAAAAA";
    private static final String UPDATED_TYPE_EVALU = "BBBBBBBBBB";
    ...
    void getAllEvaluations() throws Exception {
        ...
        restEvaluationMockMvc
            ...
            .andExpect(jsonPath("$.[*].typeEvalu").value(hasItem(DEFAULT_TYPE_EVALU)))
    ...
    void getEvaluation() throws Exception {
        ...
        restEvaluationMockMvc
            ...
            .andExpect(jsonPath("$.typeEvalu").value(DEFAULT_TYPE_EVALU))
