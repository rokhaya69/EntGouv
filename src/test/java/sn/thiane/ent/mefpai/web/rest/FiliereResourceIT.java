...
import sn.thiane.ent.mefpai.domain.Filiere;
import sn.thiane.ent.mefpai.domain.enumeration.NomFiliere;
import sn.thiane.ent.mefpai.domain.enumeration.Qualification;
import sn.thiane.ent.mefpai.repository.FiliereRepository;
...
class FiliereResourceIT {
    ...
    public static Filiere createEntity(EntityManager em) {
        Filiere filiere = new Filiere().nomFiliere(DEFAULT_NOM_FILIERE).niveauQualif(DEFAULT_NIVEAU_QUALIF);
        return filiere;
    }
    ...
    public static Filiere createUpdatedEntity(EntityManager em) {
        Filiere filiere = new Filiere().nomFiliere(UPDATED_NOM_FILIERE).niveauQualif(UPDATED_NIVEAU_QUALIF);
        return filiere;
    }
    ...
    void putNewFiliere() throws Exception {
        ...
        updatedFiliere.nomFiliere(UPDATED_NOM_FILIERE).niveauQualif(UPDATED_NIVEAU_QUALIF);
