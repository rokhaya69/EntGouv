...
import sn.thiane.ent.mefpai.repository.RessourceRepository;
...
class RessourceResourceIT {
    ...
    private static final String DEFAULT_LIEN_RESSOURCE = "AAAAAAAAAA";
    private static final String UPDATED_LIEN_RESSOURCE = "BBBBBBBBBB";
    ...
    @Test
    @Transactional
    void checkLienRessourceIsRequired() throws Exception {
        int databaseSizeBeforeTest = ressourceRepository.findAll().size();
        // set the field null
        ressource.setLienRessource(null);
    ...
    void getAllRessources() throws Exception {
        ...
        restRessourceMockMvc
            ...
            .andExpect(jsonPath("$.[*].lienRessource").value(hasItem(DEFAULT_LIEN_RESSOURCE)))
    ...
    void getRessource() throws Exception {
        ...
        restRessourceMockMvc
            ...
            .andExpect(jsonPath("$.lienRessource").value(DEFAULT_LIEN_RESSOURCE))
